...
export default function ReportsPage() {
  ...
  const attendanceRate = ((presentCount / mockAttendance.length) * 100).toFixed(0);
  const completedTasks = mockTasks.filter(t => t.status === "completed").length;
  const taskSuccessRate = ((completedTasks / mockTasks.length) * 100).toFixed(0);
    ...
    <div className="fade-in" style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "16px" }}>
        ...
        <div className="card" style={{ display: "flex", gap: "12px", alignItems: "center" }}>
          ...
          <div>
            <div style={{ fontSize: "20px", fontWeight: 800 }}>{mockTasks.length} Assigned</div>
