              ...
              <form onSubmit={handleCompleteSetup} style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                ...
                <div style={{
                  ...
                  >
                    {loading ? (
                      <>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" style={{ animation: "spin 1s linear infinite" }}><path d="M21 12a9 9 0 1 1-6.219-8.56" /></svg>
                        Setting up account...
                      </>
                    ) : (
                      <>
