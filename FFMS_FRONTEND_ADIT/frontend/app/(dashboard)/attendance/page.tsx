...
export default function AttendancePage() {
  ...
  const present = attendance.filter(a => ["present", "late", "half_day"].includes(a.status)).length;
  const absent  = attendance.filter(a => ["absent", "leave", "holiday"].includes(a.status)).length;
